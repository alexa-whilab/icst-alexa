...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        response_text, response_builder = conversation_manager.initate_conversation(response_builder, user_utterance, session_data)
...
class InfoIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        user_utterance = util.get_user_utterance(handler_input)
        session_data = util.get_session_data(handler_input)
        response_text, response_builder = conversation_manager.process_request(response_builder, user_utterance, session_data)
